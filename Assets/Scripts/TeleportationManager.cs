...
public class TeleportationManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var acitvate = actionAsset.FindActionMap("XRI LeftHand").FindAction("Teleport Mode Activate");
        acitvate.Enable();
        acitvate.performed += OnTeleportActivate;

        var cancel = actionAsset.FindActionMap("XRI LeftHand").FindAction("Teleport Mode Activate");
        cancel.Enable();
        cancel.performed += OnTeleportActivate;
